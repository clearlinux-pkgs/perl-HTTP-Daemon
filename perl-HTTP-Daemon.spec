...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Daemon-6.14.tar.gz
...
%prep
%setup -q -n HTTP-Daemon-6.14
cd %{_builddir}/HTTP-Daemon-6.14
...
cp %{_builddir}/HTTP-Daemon-6.14/LICENCE %{buildroot}/usr/share/package-licenses/perl-HTTP-Daemon/5816a49d54f43b60fe3caaa9b79f327c060f646e
if test -f Makefile.PL; then
