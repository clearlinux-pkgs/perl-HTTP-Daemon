...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Daemon-6.12.tar.gz
...
%prep
%setup -q -n HTTP-Daemon-6.12
cd %{_builddir}/HTTP-Daemon-6.12
...
cp %{_builddir}/HTTP-Daemon-6.12/LICENCE %{buildroot}/usr/share/package-licenses/perl-HTTP-Daemon/e9330dd55cc5b12a4e89bca611863182e2acf7d1
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.32.1/HTTP/Daemon.pm
